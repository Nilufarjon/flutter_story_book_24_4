...
class ThemeNotifier with ChangeNotifier {
  ...
  static final themeColorsList = <Color>[
    colorPrimary,
    deepPurpleColorPrimary,
    pinkColorPrimary,
    orangeColorPrimary,
    greenColorPrimary,
    grayColorPrimary
  ];
  static final themeBgColorsList = <Color>[
    navcolorPrimary,
    navdeepPurpleColorPrimary,
    navpinkColorPrimary,
    navorangeColorPrimary,
    navgreenColorPrimary,
    navgrayColorPrimary
  ];
  ...
  static ThemeData darkTheme = ThemeData(
      ...
      colorScheme: ColorScheme.fromSwatch()
          ...
          .copyWith(primary: Colors.grey, background: "#0A0A0A".toColor()));
